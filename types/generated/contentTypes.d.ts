...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog content type with nested categories, tags, and comments';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    categories: Schema.Attribute.Component<'content.blog-category', true>;
    comments: Schema.Attribute.Component<'content.blog-comment', true>;
    ...
    tags: Schema.Attribute.Component<'content.blog-tag', true>;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Case Study content type with nested categories, tags, and comments';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    categories: Schema.Attribute.Component<'content.case-study-category', true>;
    comments: Schema.Attribute.Component<'content.case-study-comment', true>;
    content: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    tags: Schema.Attribute.Component<'content.case-study-tag', true>;
    thumbnail: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
